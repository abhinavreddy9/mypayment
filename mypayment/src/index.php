        ...
        <div class="modal" id="signupModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="bank" class="sr-only">Enter your Bank Account Number:</label>
                      <input class="form-control" type="text" name="bank" id="bank" placeholder="Bank Account Number" maxlength="30" required>
                  </div>
                  <div class="form-group">
                      <label for="balance" class="sr-only">Enter Amount to be moved from your bank:</label>
                      <input class="form-control" type="password" name="balance" id="balance" placeholder="Enter balance" maxlength="30" required>
                  </div>
              </div>
              <div class="modal-footer">
